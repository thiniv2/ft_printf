...
/*   Updated: 2021/05/26 15:04:23 by thinguye         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//  TEST 4
	ret1 =  sprintf(s1, "a4: |%.0f|", f);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b4: |%.0f|", f);
	ft_printf(" %d\n", ret2);
...
//  TEST 15
	ret1 =  sprintf(s1, "a15: |%5.f|", f);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b15: |%5.f|", f);
	ft_printf(" %d\n", ret2);
...
//  TEST 7
	ret1 =  sprintf(s1, "a7: |%-05%|");
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b7: |%-05%|");
	ft_printf(" %d\n", ret2);
...
//  TEST 2
	ret1 =  sprintf(s1, "a2: |%5.3s|", str);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b2: |%5.3s|", str);
	ft_printf(" %d\n", ret2);

//  TEST 3
	ret1 =  sprintf(s1, "a3: |%16.6s|", str);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b3: |%16.6s|", str);
	ft_printf(" %d\n", ret2);
...
//  TEST 21
	ret1 =  sprintf(s1, "a21: |%+10.5d|", i);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b21: |%+10.5d|", i);
	ft_printf(" %d\n", ret2);

//  TEST 22
	ret1 =  sprintf(s1, "a22: |%05.3d|", i);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b22: |%05.3d|", i);
	ft_printf(" %d\n", ret2);

//  TEST 23
	ret1 =  sprintf(s1, "a23: |%.d|", i);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b23: |%.d|", i);
	ft_printf(" %d\n", ret2);

//  TEST 24
	ret1 =  sprintf(s1, "a24: |%15.4d|", i);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b24: |%15.4d|", i);
	ft_printf(" %d\n", ret2);
...
//	TEST 4
	ret1 = sprintf(s1, "a4: |%#+05.3u|", i);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b4: |%#+05.3u|", i);
	ft_printf(" %d\n", ret2);
...
//	TEST 6
	ret1 = sprintf(s1, "a6: |%08.5u|", i);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b6: |%08.5u|", i);
	ft_printf(" %d\n", ret2);
	
//	TEST 7
	ret1 = sprintf(s1, "a7: |%-#25.23llu|", LLONG_MAX);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b7: |%-#25.23llu|", LLONG_MAX);
	ft_printf(" %d\n", ret2);

//	TEST 8
	ret1 = sprintf(s1, "a8: |%# 5.3u|", i);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b8: |%# 5.3u|", i);
	ft_printf(" %d\n", ret2);

//	TEST 9
	ret1 = sprintf(s1, "a9: |%0-8.5u|", i);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b9: |%0-8.5u|", i);
	ft_printf(" %d\n", ret2);
	...
	ret1 = sprintf(s1, "o umax: |%0-25.23llo|", ULLONG_MAX);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("o umax: |%0-25.23llo|", ULLONG_MAX);
	ft_printf(" %d\n", ret2);
	...
	sprintf(s1, "TESTING POINTER\n");
	write(1, s1, strlen(s1));
	i = 42;

//	TEST 1
	ret1 = sprintf(s1, "a1: |%p|", i);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b1: |%p|", i);
	ft_printf(" %d\n", ret2);

//	TEST 2
	ret1 = sprintf(s1, "a2: |%.5p|", 0);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b2: |%.5p|", 0);
	ft_printf(" %d\n", ret2);

//	TEST 3
	ret1 = sprintf(s1, "a3: |%04.p|", 42);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b3: |%4.p|", 42);
	ft_printf(" %d\n", ret2);

//	TEST 4
	ret1 = sprintf(s1, "a4: |%16.12p|", "hello");
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b4: |%16.12p|", "hello");
	ft_printf(" %d\n", ret2);

//	TEST 5
	ret1 = sprintf(s1, "a5: |%4.p|", 0);
	write(1, s1, strlen(s1));
	ft_printf(" %d\n", ret1);
	ret2 = ft_printf("b5: |%4.p|", 0);
	ft_printf(" %d\n", ret2);
